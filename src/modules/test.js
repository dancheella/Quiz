  ...
  complete() {
    ...
    if (xhr.status === 200 && xhr.responseText) {
      ...
      if (result) {
        ...
        location.href = '#/result?name=' + this.routeParams.name + '&lastName=' + this.routeParams.lastName +
          '&email=' + this.routeParams.email + '&id=' + this.routeParams.id + '&score=' + result.score + '&total=' +
          result.total + '&testId=' + this.routeParams.id + '&results=' + answersCorrect;
      }
    } else {
      location.href = '#/';
    }
